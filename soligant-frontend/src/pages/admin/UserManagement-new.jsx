...
const UserManagement = () => {
  ...
  const handleCreateSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        alert(`Lỗi khi tạo người dùng: ${error.message || error}`);
      }
    },
  ...
  const handleEditSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        alert(`Lỗi khi cập nhật người dùng: ${error.message || error}`);
      }
    },
  ...
  const handleDeleteSubmit = useCallback(async () => {
    ...
    try {
      ...
      alert(`Lỗi khi xóa người dùng: ${error.message || error}`);
    }
  ...
  const handlePasswordSubmit = useCallback(
    async (e) => {
      ...
      if (!selectedUser) {
        alert("Không tìm thấy người dùng để đổi mật khẩu");
        return;
      }
      ...
      try {
        ...
        alert(`Lỗi khi đổi mật khẩu: ${error.message || error}`);
      }
    },
